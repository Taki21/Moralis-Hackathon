...
function Connect() {
    ...
    return (
        <>
            <div>
                <button onClick={() => authenticate()} className="flex max-h-12 text-2xl px-3 py-3 rounded-2xl shadow-lg bg-[#dfdfdf] text-[#111111] hover:bg-[#D3B694] hover:text-white rounded-15xl hover:rounded-xl transition-all duration-600 ease-linear cursor-pointer">
                    {
                        isAuthenticated ? (
