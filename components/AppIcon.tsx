function AppIcon() {
    return (
        <>
            <div>
                <button className="bg-[#101011] px-3 py-3 text-2xl rounded-2xl text-emerald-500 font-semibold hover:text-white hover:bg-emerald-500 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
