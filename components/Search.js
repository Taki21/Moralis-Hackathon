function Search({placeholder, data}) {
    return (
        <>
            ...
            <div className="search w-1/3 bg-[#dfdfdf] rounded-2xl  px-4 flex items-center text-slate-700 text-xl text-[#444444]">
                ...
                <input className="form-control w-96 relative focus:outline-none flex-auto min-w-0 block px-3 py-1.5 text-base font-normal focus:text-[#9ca3af] placeholder-[#475569] placeholder-opacity-50 bg-[#dfdfdf] bg-clip-padding border-none transition ease-in-out m-0 focus:border-none" type="text" placeholder={placeholder}></input>
