...
function Sidebar() {
    ...
    return (
        <>
            <div className="flex sticky top-0 left-0 h-screen w-48 m-0 flex-col bg-[#ffffff] text-white">
                <div className="bg-[#ebebeb] h-full my-8 mx-8 rounded-3xl flex flex-col justify-between">
                    <div className="h-16 w-16 rounded-2xl my-8 mx-auto shadow-lg bg-[#dfdfdf] text-white hover:bg-[#D3B694] hover:text-white rounded-15xl hover:rounded-xl transition-all duration-600 ease-linear cursor-pointer">
                    ...
                    <div>
                        <Link href='../'> 
                            <a>
                                <div className="group relative flex items-center justify-center h-16 w-16 rounded-2xl my-8 mx-auto shadow-lg bg-[#dfdfdf] text-white hover:bg-[#D3B694] hover:text-white rounded-15xl hover:rounded-xl transition-all duration-600 ease-linear cursor-pointer">
                        ...
                        <Link href='/marketplace'> 
                            <a>
                                <div className="group relative flex items-center justify-center h-16 w-16 rounded-2xl my-8 mx-auto shadow-lg bg-[#dfdfdf] text-white hover:bg-[#D3B694] hover:text-white rounded-15xl hover:rounded-xl transition-all duration-300 ease-linear cursor-pointer">
                    ...
                    <div onClick={logout} className="group relative flex items-center justify-center h-16 w-16 rounded-2xl my-8 mx-auto shadow-lg bg-[#dfdfdf] text-white hover:bg-[#D3B694] hover:text-white rounded-15xl hover:rounded-xl transition-all duration-300 ease-linear cursor-pointer">
